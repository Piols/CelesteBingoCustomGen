...
bingoList[6] = [
  { name: "Use 3 Binoculars in B-Sides", types: ["binoculars","earlygame"] },
...
bingoList[7] = [
  ...
  { name: "1 Blue and 1 Red Heart", types: ["amount_hearts","amount_chapters"] },
  ...
  { name: "Use all Binoculars in 4A (3)", types: ["binoculars","task"] },
...
bingoList[8] = [
  ...
  { name: "Jump on 15 Snowballs", types: ["snowballs"] },
];
bingoList[9] = [
...
bingoList[10] = [
  ...
  { name: "Complete Start of 5A without jumping", types: ["task"] },
...
bingoList[13] = [
  ...
  { name: "Get 1 Key in Power Source", types: ["ch9","binoculars"] },
...
bingoList[14] = [
  ...
  { name: "Get 1 Key in Search", types: ["task","search"] },
...
bingoList[19] = [
  ...
  { name: "Reach Rock Bottom (6B Checkpoint)", types: ["6b","lategame"] },
...
bingoList[24] = [
  ...
  { name: "Complete Resolution without jumping", types: ["lategame","task"] },
...
fs.writeFile('..\\generators\\generatorJsons\\teamsBlackout.py', JSON.stringify(bingoList.slice(1,26)), { flag: 'r+' }, err => {});